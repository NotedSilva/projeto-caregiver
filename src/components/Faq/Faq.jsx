...
const dataFaq = [
  {
    question: 'Como posso me cadastrar como cuidador na plataforma "Caregiver"?',
  ...
  {
    question: 'Sou um usuário em busca de um cuidador. Como posso encontrar um cuidador adequado?',
  ...
  {
    question: 'Como funciona o sistema de pagamento na plataforma "Caregiver"?',
  ...
  {
    question: 'Existe um sistema de chat para comunicação entre cuidadores e usuários?',
